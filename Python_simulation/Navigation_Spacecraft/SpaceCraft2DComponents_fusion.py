...
def create_merlin_cluster():
    ...
    positions.append((0, 0))  # Motor central
...
def plot_mesh(mesh):
    ...
    plt.tight_layout()
    plt.savefig("/mnt/c/Users/PC/PycharmProjects/pythonProject1/Craft2D.png", dpi=300)
    plt.close()
...
parts = [
    ...
    *create_merlin_cluster(),
    *create_wings(),
    *create_shield_alternative(),
    *create_sensors(),
    *create_antennas(),
    *create_fighter_wing(),
    create_dome(),
...
combined_model = combine_meshes(parts)
plot_mesh(combined_model)
